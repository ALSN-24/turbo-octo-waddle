 ...
 *
 * Shown after a successful account creation. With credential auth, registration
 * signs the user in immediately, so this page simply confirms success and links
 * to the dashboard.
 *
