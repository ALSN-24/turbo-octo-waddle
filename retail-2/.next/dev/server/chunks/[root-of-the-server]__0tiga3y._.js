...
async function getAuthenticatedUser(request) {
    ...
    try {
        const { payload } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$jwt$2f$verify$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["jwtVerify"])(token, getSecret());
        return payload;
    } catch  {
        return null;
    }
...
async function proxy(request) {
    ...
    if (pathname.startsWith('/api/')) {
        ...
        if (isPublicApi) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].next();
        if (!user) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0tiga3y._.js.map